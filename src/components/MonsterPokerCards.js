...
const SHOW_MONSTER_CARDS = true;

const SHOW_COPIES = true;

// Constants and Default Settings
const FONT_SIZE = ONLINE ? 100 : 70; //print v1 was 85
const MULTIPLIER_ICON_SIZE = ONLINE ? 50 : 25;
const CD_ICON_ENLRAGEMENT = 10;
const VARIANT_ICON_SIZE_FACTOR = 0.7;
const MARGIN_SIZE = ONLINE ? 20 : 55;
const CONTENT_PADDING = ONLINE ? 10 : 30;
const CARD_WIDTH = 635;
const CARD_HEIGHT = 888;
const SAVE_SCALE = ONLINE ? 0.4 : 2;
...
const DISPLAY_SETTINGS = {
    ...
    startIcon: "0",//"https://ka2le.github.io/chatgpt-apps3/images/mp/extra_icons/card_lift.png",
    ...
    playerIcon: "https://ka2le.github.io/chatgpt-apps3/images/mp/extra_icons/pawn.png",
    shieldBreakIcon: "https://ka2le.github.io/chatgpt-apps3/images/mp/shield_break.png",
};
...
const BASE_CARDS = [
    ...
    },
    {
        ...
        "images": [
            ...
            //"https://cdn.midjourney.com/72580de6-343e-425e-a28c-00efaceabc7b/0_1.png", butler
            //"https://cdn.midjourney.com/0784c063-7ae5-4964-a34c-7ca6f7104299/0_0.png",monkey
            "https://cdn.midjourney.com/e86980b7-f91f-4779-9ab7-bde332e4cbe6/0_3.png",
...
const EXTRA_CARDS = [
    ...
    //
    {
        ...
        "copies": 1,
        "images": [
            "https://cdn.midjourney.com/dcdbb743-a2fa-4d98-b166-3cea3c7a4c8e/0_3.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
    ...
    },
    {
        ...
        "customEffect": [
            ...
            DISPLAY_SETTINGS.dmgIcon,
            "*",
            DISPLAY_SETTINGS.shieldBreakIcon
        ],
        "cd": 1,
        "variants": [0],
    },
...

    {
        ...
        "images": [
            ...
            "https://cdn.midjourney.com/6d95c38c-75be-48a7-a196-2cb66d9fb807/0_0.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
    ...
    },
    {
        ...
        "images": [
            //"https://cdn.midjourney.com/1f507dbc-2a46-4285-a1ba-d0a68b183141/0_0.png",bleed
            "https://cdn.midjourney.com/6aa0e29c-c0d9-482d-9180-07c3e06a2d66/0_0.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
    ...
    {
        "cardName": "discard_to_dmg",
        "copies": 1,
        "images": [
            "https://cdn.midjourney.com/501fcd90-35ed-4e02-9b0d-7b8d8917a4b8/0_3.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
        "customEffect": [
            "https://ka2le.github.io/chatgpt-apps3/images/mp/extra_icons/cards_return.png",
            " ",
    ...
    {
        "cardName": "opponent_discards",
        "copies": 1,
        "images": [
            "https://cdn.midjourney.com/59921c51-aa0a-4cff-b61f-f514e801e80c/0_2.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
    ...
    {
        "cardName": "discard_to_hp",
        "copies": 1,
        "images": [
            "https://cdn.midjourney.com/d36bc28c-3a37-408c-8bae-fda77593860c/0_2.png",
        ],
        "cardType": "action",
        "stats": [],
        "effect": {},
...
const DEFAULT_CARDS2 = [...(SHOW_MONSTER_CARDS ? MONSTER_CARDS : []), ...DEFAULT_CARDS1, ...(SHOW_BASE_CARDS ? BASE_CARDS : [])];
const DEFAULT_CARDS = ONLY_EXTRA_CARDS ? EXTRA_CARDS : [...(NO_EXTRA_CARDS ? [] : EXTRA_CARDS), ...DEFAULT_CARDS2,];
...
const Card = ({ card, index }) => {
    ...
    const getVariantIcon = (index) => {
        if (!card?.variants || card?.variants?.length === 0) {
            return <IconOrImage value={VARIANT_ICONS[index % VARIANT_ICONS.length]?.icon} fontSize={FONT_SIZE * VARIANT_ICON_SIZE_FACTOR} />;
        }

        const variantValue = card.variants[index % card.variants.length];
        if (variantValue === -1) return null;

        return <IconOrImage value={VARIANT_ICONS[variantValue % VARIANT_ICONS.length]?.icon} fontSize={FONT_SIZE * VARIANT_ICON_SIZE_FACTOR} />;
    };
                    ...
                    {card.cardType === "action" && card.cd !== undefined && (
                        <div style={{ ...styles.card.verticalLock, marginLeft: "-10px" }}>
                            {card.cd == "-100" ? (
                                ...
                                <IconOrImage value={DISPLAY_SETTINGS.cardTakeIcon} fontSize={FONT_SIZE + 10} />
                                // <IconOrImage value={DISPLAY_SETTINGS.startIcon} fontSize={FONT_SIZE + 10} />

                            ) :
                                (card.cd < 1 ?
                                    (<>
                                        <IconOrImage value={card.cd * -1} fontSize={FONT_SIZE + 10} />
