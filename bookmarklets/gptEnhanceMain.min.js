!function(){function t(t,e,n){var o=document.getElementsByTagName("head")[0],a=document.createElement("script");a.type="text/javascript",a.onerror=function(){var t;e&&(console.log("Fallback"),(t=document.createElement("script")).type="text/javascript",t.src=e,t.onreadystatechange=n,t.onload=n,o.appendChild(t))},a.src=t,a.onreadystatechange=n,a.onload=n,o.appendChild(a)}console.log("gptEnchanceMain 1.0");var e="http://localhost:3000/chatgpt-apps3/bookmarklets/utils.js?"+(new Date).getTime(),n="https://ka2le.github.io/chatgpt-apps3/bookmarklets/utils.js?"+(new Date).getTime();t("https://unpkg.com/preact@latest/dist/preact.umd.js",null,function(){console.log("Preact has been loaded!"),t("https://unpkg.com/htm@latest/dist/htm.umd.js",null,function(){console.log("HTM has been loaded!"),t("https://unpkg.com/preact@latest/hooks/dist/hooks.umd.js",null,function(){window.h=preact.h,window.render=preact.render,window.html=htm.bind(h),window.useState=preactHooks.useState,window.useEffect=preactHooks.useEffect,t(e,n,function(){function t(){insertTextInPrompt(`
