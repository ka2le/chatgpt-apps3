javascript:(function() {!function(){function e(e,t,n){var o=document.getElementsByTagName("head")[0],a=document.createElement("script");a.type="text/javascript",a.onerror=function(){var e;t&&((e=document.createElement("script")).type="text/javascript",e.src=t,e.onreadystatechange=n,e.onload=n,o.appendChild(e))},a.src=e,a.onreadystatechange=n,a.onload=n,o.appendChild(a)}console.log("GPT MAIN: 1685824209077");var t="http://localhost:3000/chatgpt-apps3/bookmarklets/min/utils.min.js?"+(new Date).getTime(),n="https://ka2le.github.io/chatgpt-apps3/bookmarklets/min/utils.min.js?"+(new Date).getTime();e("https://unpkg.com/preact@latest/dist/preact.umd.js",null,function(){e("https://unpkg.com/htm@latest/dist/htm.umd.js",null,function(){e("https://unpkg.com/preact@latest/hooks/dist/hooks.umd.js",null,function(){window.h=preact.h,window.render=preact.render,window.html=htm.bind(h),window.useState=preactHooks.useState,window.useEffect=preactHooks.useEffect,window.useRef=preactHooks.useRef,window.useMemo=preactHooks.useMemo,e(t,n,function(){n=window.render,$=window.html,E=window.useState,x=window.useEffect,k=window.useRef,B=window.useMemo;var n,$,E,x,k,B,e=function(){const[e,t]=E(!1),[n,o]=E("DND"),[a,i]=E(!1),[l,r]=E(!0),[d,s]=E(""),c=k(null),u=k(null),m=["STR","DEX","CON","INT","WIS","CHA"],p=[-2,-1,0,1,2,3,4,5],[g,h]=E({STR:0,DEX:0,CON:0,INT:0,WIS:0,CHA:0}),y=e=>{var t;c.current&&(t=c.current.value.replace(/\[.*?\]/s,""),c.current.value=t+"["+e+"]",c.current.dispatchEvent(new Event("input",{bubbles:!0})))},v=()=>{u.current&&"BUTTON"===u.current.tagName&&(u.current.disabled=!1,u.current.click())},f=(x(()=>{y(d)},[d]),()=>{i(!a)}),[b,w]=E(!1);var T=B(()=>({standardAbilities:m,standardScoreOptions:p,toggleOverlay:f,isOverlayOpen:a,toggleToolWindow:()=>{r(!l)},isToolWindowVisible:l,setAdditionalText:s,mode:n,setMode:o,addToAddtionalText:e=>{s(d+e)},haveRemoved:e,setHaveRemoved:t,triggerRender:b,textAreaRef:c,sendButtonRef:u,insertTextInPrompt:y,sendText:e=>{console.log("Sending"+e),y(e),v()},pressSend:v,abilityScores:g,setAbilityScores:h}),[f,a,e,t,b,l,r,c,u,g]);return useComponentContainer(O,findToolBarContainerDOM,T),useComponentContainer(C,findOverlayContainerDOM,T),x(()=>{c.current=document.getElementById("prompt-textarea"),u.current=document.getElementById("prompt-textarea").nextElementSibling},[]),x(function(){removeElementsByClass("gpt-enhancer",e,t),A(),S(),addObserver([function(){A()},function(){S()},function(){addStyling()},function(){w(e=>!e)}]),addStyling()},[e,w,b]),$`<${R} ...${T} />`},t="gpt-enhancer-root",o=(o=t,(o=document.getElementById(o))&&o.remove(),document.createElement("div"));function S(){for(var e=document.getElementsByTagName("main")[0].getElementsByTagName("ol"),t=0;t<e.length;t++)for(var n,o,a,i=e[t].getElementsByTagName("li"),l=0;l<i.length;l++)i[l].classList.contains("has-checkbox")||((n=document.createElement("input")).type="checkbox",o=l+1,a=i[l].innerHTML.replace(/<[^>]*>?/gm,""),n.dataset.listText="Option "+o+": "+a,i[l].style.display="flex",i[l].style.alignItems="center",i[l].insertBefore(n,i[l].firstChild),i[l].classList.add("has-checkbox"))}function a(){var e=document.getElementById("codeBox").value;console.log(e),runJs(e)}function i(e,t){var n=Math.floor(20*Math.random())+1,o=function(e){for(var t=0;t<e.length;t++)if(e[t].checked)return e[t].dataset.listText;return""}(0<(i=document.getElementsByTagName("main")[0].getElementsByTagName("ol")).length?i[i.length-1].getElementsByTagName("input"):[]);let a;t.forEach(e=>{o.includes("("+e+")")&&(a=e)});var i=parseInt(document.getElementById(a+"Dropdown")?.value??0),t=null!=a?-1<i?" + "+i+" "+a:i+" "+a:"",i=n+parseInt(i);e(o+` Result: ${i} (${n} Roll ${t})`)}function A(){document.querySelectorAll("button:not([gpt-enhancer-modified])").forEach(function(e){var t;e.innerText.includes("Copy code")&&(e.setAttribute("gpt-enhancer-modified","true"),t=e.innerText.replace("Copy code","Copy"),e.setAttribute("innerHtml",t),t=document.createElement("div"),n($`<${RunJsButton} spanElement=${e}/>`,t),addElement(e.parentElement,t,e.nextSibling),t=document.createElement("div"),n($`<${DownloadSVGButton} spanElement=${e}/>`,t),addElement(e.parentElement,t,e.nextSibling),t=document.createElement("div"),n($`<${ToggleEditableButton} spanElement=${e}/>`,t),addElement(e.parentElement,t,e.nextSibling))})}function C(e){const[t,n]=E();return $`
            ...
            `}function O(e){return $`
                <div 
                    ...
                    <${function(e){return"DND"==e.mode||"ALL"==e.mode?$`
            ${Button("Roll D20",function(){i(e.setAdditionalText,e.standardAbilities)})}            
...
Always do comments in the code like /*COMMENT HERE*/ never do // like //COMMENT HERE  `)})}
            ...
            `}function R(e){return console.log(e),console.log(e.isToolWindowVisible),$`
                <div 
