javascript:(function() {!function(){function e(e,t,n){var o=document.getElementsByTagName("head")[0],a=document.createElement("script");a.type="text/javascript",a.onerror=function(){var e;t&&((e=document.createElement("script")).type="text/javascript",e.src=t,e.onreadystatechange=n,e.onload=n,o.appendChild(e))},a.src=e,a.onreadystatechange=n,a.onload=n,o.appendChild(a)}console.log("GPT MAIN: 1685914150770");var t="http://localhost:3000/chatgpt-apps3/bookmarklets/min/utils.min.js?"+(new Date).getTime(),n="https://ka2le.github.io/chatgpt-apps3/bookmarklets/min/utils.min.js?"+(new Date).getTime();e("https://unpkg.com/preact@latest/dist/preact.umd.js",null,function(){e("https://unpkg.com/htm@latest/dist/htm.umd.js",null,function(){e("https://unpkg.com/preact@latest/hooks/dist/hooks.umd.js",null,function(){window.h=preact.h,window.render=preact.render,window.html=htm.bind(h),window.useState=preactHooks.useState,window.useEffect=preactHooks.useEffect,window.useRef=preactHooks.useRef,window.useMemo=preactHooks.useMemo,window.useCallback=preactHooks.useCallback,e(t,n,function(){n=window.render,r=window.html,d=window.useState,u=window.useEffect,window.useRef,c=window.useMemo,window.useCallback;var n,r,d,u,c,e=function(){const e=["ALL","DND","CODE"],[t,n]=d("ALL"),[o,a]=d(!1),[i,l]=d(!1),s=c(()=>({availableModes:e,mode:t,setMode:n,haveRemoved:o,setHaveRemoved:a,triggerRender:i,...useTextArea(),...useSendButton(),...useDndVariables(),...useContainerVisibility(t)}),[e,t,o,i]);return useComponentContainer(f,findToolBarContainerDOM,s),useComponentContainer(h,findOverlayContainerDOM,s),useComponentContainer(v,findOverlayContainerDOM,s),u(function(){removeElementsByClass("gpt-enhancer",o,a),g(),p(),s.sendButtonClickListener(),addClassObserver([function(){console.log("Callbak from Class Observer function running")},function(){p()},function(){g()},function(){addStyling()},function(){l(e=>!e)}]),addObserver([function(){g()},function(){p()},function(){console.log("Callbak function running")},function(){addStyling()},function(){l(e=>!e)}]),addStyling()},[o,l,i]),r`<${function(e){return r`
                <div 
...
Always do comments in the code like /*COMMENT HERE*/ never do // like //COMMENT HERE  `)})}
            ...
            `}function h(e){const[t,n]=d();return r`
